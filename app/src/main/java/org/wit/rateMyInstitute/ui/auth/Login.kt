package org.wit.rateMyInstitute.ui.auth
...
import org.wit.rateMyInstitute.databinding.LoginBinding
...
import org.wit.rateMyInstitute.ui.home.Home
...
class Login : AppCompatActivity() {
    ...
    private fun googleSignIn() {
        ...
        Timber.i( "googleSignIn: $signInIntent")
    ...
    private fun setupGoogleSignInCallback() {
        startForResult =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                Timber.i( "setupgooglesignincallback - $result")
                when(result.resultCode){
                    RESULT_OK -> {
                        val task = GoogleSignIn.getSignedInAccountFromIntent(result.data)
                        Timber.i( "setupgooglesignincallback : $task")
                        try {
                        ...
                        Timber.i("rateMyInstitute Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
